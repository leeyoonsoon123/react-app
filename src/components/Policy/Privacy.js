            ...
            <div>
                ...
                <div className='container' >
                    ...
                    <div className='f-m'>Delius 개인정보 취급방침</div>
                        ...
                        <strong>DELIUS 서비스(필수)</strong> - 휴대폰 번호, 스마트폰 등 단말기 주소록 내 연락처 정보, 이용자의 이름과 생년월일, 실명인증(닉네임), 위치, 성별, 프로필 사진, 사용기기의 확인<br />
                        ...
                        3.	여러분의 개인정보의 수집 및 이용목적이 달성되면 법령 또는 내부방침에 의해 보존할 필요가 있는 경우를 제외하고는 개인정보가 파기됩니다. 절차 및 방법은 다음과 같습니다.<br />
                        &nbsp; 3.1 보존 항목 : 계약 또는 청약철회 등에 관한 기록<br />
                        &nbsp; - 근거 법령: 전자상거래 등에서의 소비자보호에 관한 법률<br/>
                        &nbsp; - 보존 기간: 5년 <br/>
                        &nbsp; 3.2 보존 항목 : 대금결제 및 재화 등의 공급에 관한 기록<br />
                        &nbsp; - 근거 법령: 전자상거래 등에서의 소비자보호에 관한 법률<br/>
                        &nbsp; - 보존 기간: 5년 <br/>
                        &nbsp; 3.3 보존 항목 : 소비자의 불만 또는 분쟁처리에 관한 기록 <br />
                        &nbsp; - 근거 법령: 전자상거래 등에서의 소비자보호에 관한 법률<br/>
                        &nbsp; - 보존 기간: 3년 <br/>
                        &nbsp; 3.4 보존 항목 : 표시/광고에 관한 기록<br />
                        &nbsp; - 근거 법령: 전자상거래 등에서의 소비자보호에 관한 법률<br/>
                        &nbsp; - 보존 기간: 6개월 <br/>
                        &nbsp; 3.5 보존 항목 :세법이 규정하는 모든 거래에 관한 장부 및 증빙서류 <br />
                        &nbsp; - 근거 법령: 국세기본법<br/>
                        &nbsp; - 보존 기간: 5년 <br/>
                        &nbsp; 3.6 보존 항목 : 전자금융 거래에 관한 기록<br />
                        &nbsp; - 근거 법령: 전자금융거래법<br/>
                        &nbsp; - 보존 기간: 5년 <br/>
                        &nbsp; 3.7 보존 항목 : 웹사이트 방문 기록<br />
                        &nbsp; - 근거 법령: 통신 비밀 보호법<br/>
                        &nbsp; - 보존 기간: 3개월 <br/>
                       <br /><br />
                        </div>
                        ...
                        <div className="f-s mg-top-1">
                        &nbsp; [DELIUS 사내 정보관리책임자]<br />
                        &nbsp; 이름: 김재승<br/>
                        &nbsp; 메일: delius_pjh@delius-company.com <br/><br /><br />
                        </div>
                        ...
                        <div className="f-s mg-top-1">
                        &nbsp; [개인정보 침해 신고센터(한국인터넷진흥원 운영)]<br />
                        &nbsp; - 업무내용: 개인정보 침해사실 신고 및 상담 신청<br/>
                        &nbsp; - 전화번호: 국번 없이 118 <br/><br />
                        &nbsp; [경찰청 사이버안전국] <br />
                        &nbsp; - 전화번호: 국번없이 182 <br />
                        <br /><br />
                        </div>
